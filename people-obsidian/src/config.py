...
# Obsidian vault 경로 - 환경 변수 우선, 없으면 기본값
VAULT_PATH = Path(os.getenv('VAULT_PATH', Path.home() / "Desktop" / "SecondBrain"))
PEOPLE_FOLDER = Path(os.getenv('PEOPLE_FOLDER', VAULT_PATH / "07 people"))
